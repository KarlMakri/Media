...
{
    /**
     * @Route("/api", name="media_api", methods="GET")
     */
    public function api(MediaRepository $mediaRepository): JsonResponse
    {
        return new JsonResponse(
          $mediaRepository->findAllAssoc());
    }
    ...
    public function edit(Request $request, Media $medium): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('media_index', ['id' => $medium->getId()]);
        }
